...
@Component({
  selector: 'app-landlord-insurance.component',
  imports: [],
  templateUrl: './landlord-insurance.component.html',
  styleUrl: './landlord-insurance.component.scss',
})
export class LandlordInsuranceComponent implements AfterViewInit {
  ngAfterViewInit() {
  ...
  private animateImportantNotes() {
    ...
    document.querySelectorAll('.warning-box, .info-box, .callout-box').forEach(note => {
